...
const PricingCard: React.FC<PricingCardProps> = ({ product, purchaseBtn }) => {
  return (
    <div className="w-[348px] h-[777px] bg-white rounded-xl flex flex-col justify-between px-14 py-16">
      <div className="flex flex-col">
        <h3 className="text-center uppercase text-2xl font-semibold mb-4">
          {product.name}
        </h3>
        <h2 className="text-3xl text-center font-bold mb-5">
          {toRupiah(product.price)}
        </h2>
        <p className="text-[18px] text-center w-[236px] mx-auto mb-4">
          {product.description}
        </p>
