  ...
  return (
    <div className="w-full h-screen bg-gray-100">
      <div className="w-full flex flex-col max-w-[1112px] mx-auto pt-[80px] mb-10">
        <h1 className="text-5xl font-semibold text-primary mb-10">Your Cart</h1>
        <div className="flex items-start justify-between">
          <div id="product-card" className="flex flex-col w-[726px] h-[240px] bg-white rounded shadow-xl p-[24px]">
            <h3 className="text-3xl font-semibold text-primary tracking-wide mb-5">Hosting {product?.name}</h3>
            <hr />
          ...
          <div id="checkout-card" className="flex flex-col justify-between p-[24px] w-[300px] h-[200px] shadow-xl bg-white">
            ...
            <button onClick={handleSubmit} className="bg-primary text-white hover:bg-transparent hover:text-primary border border-primary text-bold uppercase duration-150 rounded py-3">
              Checkout
            </button>
          </div>
        </div>
