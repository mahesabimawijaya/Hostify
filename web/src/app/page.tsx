...
import { IHeroSection, IPricingSection, IReviewSection, IServiceSection, IWhyUsSection, PurpleAttributes } from "@/types/asset";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <ServiceSection serviceSection={asset?.serviceSection as IServiceSection} />
